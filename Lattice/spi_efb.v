...
/* Module Version: 1.2 */
/* /usr/local/diamond/3.13/ispfpga/bin/lin64/scuba -w -n spi_efb -lang verilog -synth lse -bus_exp 7 -bb -type efb -arch xo3c00f -freq 50 -spi -spi_mode Slave -spi_rxr -spi_txr -spi_en -wb -dev 9400  */
/* Tue Jan  9 22:37:19 2024 */


`timescale 1 ns / 1 ps
module spi_efb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    ...
    defparam EFBInst_0.DEV_DENSITY = "9400L" ;
